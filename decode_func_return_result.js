...
function shouldSign(_0x583393) {
  ...
  if (_0x583393['indexOf'](window['location']['host']) > -1) {
    return _0x1621fa;
  }

  if (_0x583393['indexOf']('sit.xiaohongshu.com') > -1) {
    return _0x1621fa;
  }

  BLOCKED_HOSTS['some'](function (_0x82e5a) {
    if (_0x583393['indexOf'](_0x82e5a) > -1) {
      _0x1621fa = false;
      return true;
    }
  });
...
var sign1 = sign("/api/solar/cooperator/blogger/v1?cpc=false&column=comprehensiverank&sort=asc&location=&type=&pageNum=2&pageSize=20&userType=0", undefined)
console.log(sign1)
var sign_dict = window.sign("/api/solar/cooperator/blogger/v1?cpc=false&column=comprehensiverank&sort=asc&location=&type=&pageNum=2&pageSize=20&userType=0", undefined)
console.log(sign_dict)
